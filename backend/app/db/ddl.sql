...
CREATE TABLE providers (
  provider_id INTEGER PRIMARY KEY GENERATED ALWAYS AS IDENTITY,
  ...
  provider_street_address VARCHAR(64) NOT NULL,
  provider_city VARCHAR(64) NOT NULL,
  provider_state VARCHAR(64) NOT NULL,
  provider_country VARCHAR(64) NOT NULL,
  provider_zipcode VARCHAR(64) NOT NULL,
